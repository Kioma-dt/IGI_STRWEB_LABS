...
class ContactAdmin(admin.ModelAdmin):
    ...
    search_fields = ("value", "employee_name", "email_address", "phone_number")
    readonly_fields = ("id", "created_at", "updated_at", "deleted_at")
...
class CompanyHistoryEntryAdmin(admin.ModelAdmin):
    list_display = ("year", "company", "is_deleted")
...
class PartnerAdmin(admin.ModelAdmin):
    list_display = ("name", "url", "is_active", "sort_order", "is_deleted")
...
class BannerAdmin(admin.ModelAdmin):
    list_display = ("title", "is_active", "sort_order", "is_deleted")
    list_filter = ("is_active", "is_deleted")
    search_fields = ("title",)
    readonly_fields = ("id", "created_at", "updated_at", "deleted_at")
