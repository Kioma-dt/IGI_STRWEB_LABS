...
class FilesMixin:
    """Mixin To Input Files"""
    @staticmethod
    @repeat_input
    def get_file_name(prompt: str, extension: str) -> str:
        ...
        if not re.search(fr"\.{extension}$", filename):
            filename += f'.{extension}'

        return filename
    
class FilesUserInput(UserInput, FilesMixin):
    """Class To Work With User Input Files"""
    pass
