...
urlpatterns = [
    ...
    path("products/<uuid:pk>/edit/", views.ProductUpdateView.as_view(), name="product-update"),
    ...
    path("orders/<uuid:pk>/delete/", views.OrderDeleteView.as_view(), name="order-delete"),
    # Reviews
    ...
    path("reviews/<uuid:pk>/edit/", views.ReviewUpdateView.as_view(), name="review-update"),
    path("reviews/<uuid:pk>/delete/", views.ReviewDeleteView.as_view(), name="review-delete"),
    # News
    ...
    path("news/<uuid:pk>/", views.NewsArticleDetailView.as_view(), name="news-detail"),
    path("news/<uuid:pk>/edit/", views.NewsArticleUpdateView.as_view(), name="news-update"),
    path("news/<uuid:pk>/delete/", views.NewsArticleDeleteView.as_view(), name="news-delete"),
    # Promos
    ...
    path("promos/<uuid:pk>/", views.PromoCodeDetailView.as_view(), name="promo-detail"),
    path("promos/<uuid:pk>/edit/", views.PromoCodeUpdateView.as_view(), name="promo-update"),
    path("promos/<uuid:pk>/delete/", views.PromoCodeDeleteView.as_view(), name="promo-delete"),
]
